...
dash.register_page(
    __name__,
    description="This app uses Gauge and Slider components to filter values for a scatter plot. It has a side-by-side layout with Dash Bootstrap Container component and has a regular-callback.",
)
