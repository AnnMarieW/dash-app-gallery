...
app.layout = html.Div(
    [
        ...
        html.P("Copy mtcars.csv by clicking on the clipboard below:"),
        ...
        dcc.Loading(children = [dcc.Graph(id="clipboard-csv-x-graph")], type="dot"),
        html.P("Select x variable:", style={"textAlign": "center"}),
        dcc.RadioItems(id="clipboard-csv-x-selection", 
...
def custom_copy(_, data):
    ...
    return dff.to_csv(index=False)  # include headers
...
def update_graph(col_chosen):
    fig = px.scatter(df, x=col_chosen, y='mpg',
                     labels={'disp': 'Displacement (cu.in.)',
                             'hp': 'Horsepower',
