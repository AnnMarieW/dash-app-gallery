...
app.layout = dbc.Container([
        ...
        dcc.Store(id = 'key-figures-finland-locations-x'), # Store locations for the map.
        dcc.Store(id = 'key-figures-finland-zs-x'), # Store color (z variable) for the map.
        dcc.Store(id = 'key-figures-finland-geojson-data', data = regions_json), # Store geojson for clientside callback.
        ], fluid = True)    
