...
app.layout = dbc.Container([
        ...
        dbc.Row([
            ...
            dbc.Col([
                html.H2('Key figure'),
                dcc.Dropdown(id = 'key-figures-finland-x-key-figure-selection',
...
@app.callback(Output('key-figures-finland-x-whole-country-header','children'),Input('key-figures-finland-x-key-figure-selection', 'value'))
